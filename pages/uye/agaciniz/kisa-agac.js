...
export default function Agaciniz() {
  ...
  return (<MembershipLayout>
       ...
       dataLength={Object.keys(allUsers.tree.short_tree_positions).length}
       ...
       >
        ...
        {
            Object.values(allUsers.tree.short_tree_positions).length <= 0
              ? <h2 className="w-full flex items-center justify-center font-semibold text-xl text-center ">
                Kısa ağacınızda kimse yok.
            </h2>
              : Object.values(allUsers.tree.short_tree_positions).map((item, index) => {
                console.log(item)
                console.log(index)
