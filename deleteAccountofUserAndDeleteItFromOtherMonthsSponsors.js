...
export default async function deleteAccountofUserAndDeleteItFromOtherMonthsSponsors(invitation, sponsors, usersSaleAccount, User, SaleAccount, UserWeeklyMonthlyTable) {
  try {
    ...
    console.log('ola')
    await deleteFromOldTable(documentedSponsors, UserWeeklyMonthlyTable, usersSaleAccount.owner_id)
