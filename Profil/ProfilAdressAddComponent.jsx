...
export default function ProfilAdressAddComponent({ setAddAdres,handleAddAdres }) {
  ...
  const [adresType, setAdresType] = useState({ value: 1, label: 'Bireysel' })
  ...
  const [adresTarif, setAdresTarif] = useState('')
    ...
    >
      ...
      <div>
        ...
        <div className='w-full flex justify-center mt-1'>
          ...
          <input type="text" onChange={e => setAdresTitle(e.target.value)} defaultValue={""} className="w-48 rounded-xl border-2 border-gray-300 p-2  outline-none focus:border-primary" />
        </div>
      </div>
      <div className='w-full md:h-[35%] flex mt-4 z-50 h-[75%] md:flex-row flex-col '>
        ...
        <div className="w-full h-full flex flex-col">
          ...
          <Select options={
            ...
            value={selectedIl}
            searchable defaultValue={{label:"",value:"-1"}} styles={{
          ...
          <Select options={
            ilceOptions
          } onChange={e => setSelectedIlce(e)} value={selectedIlce} searchable defaultValue={{"label":"","value":"-1"}} styles={{
            control: (baseStyles, state) => ({
              ...baseStyles,
              'borderColor': 'grey',
              'position': 'relative',
        ...
        <div className="w-full h-full flex flex-col md:border-r border-black ">
          ...
          <Select options={
            mahalleOptions
          } value={selectedMahalle} onChange={e => setSelectedMahalle(e)} searchable defaultValue={{"label":"","value":"-1"}} styles={{
            control: (baseStyles, state) => ({
              ...baseStyles,
              'borderColor': 'grey',
              'position': 'relative',
          ...
          <div className='flex w-full h-full items-center justify-center flex-col'>
            ...
            <input type='text' className="w-40 mt-2 h-[46px] border border-gray-500 rounded-lg px-2" onChange={e => setPostaKodu(e.target.value)} defaultValue={""} />
</div>
        ...
        <div className="w-full h-full flex flex-col flex-grow">
          ...
          <div className={`flex w-full h-full items-center justify-center flex-col ${adresType?.value === 2 ? "" : "hidden"}`}>
            ...
            <input type='text' className="w-40 mt-2 h-[46px] border border-gray-500 rounded-lg px-2" onChange={e => setSirketUnvan(e.target.value)} defaultValue={""} />
</div>
        ...
        <div className={`flex w-full h-full items-center justify-center flex-col ${adresType?.value === 2 ? "" : "hidden"}`}>
            ...
            <input type='text' className="w-40 mt-2 h-[46px] border border-gray-500 rounded-lg px-2" onChange={e => setVergiNo(e.target.value)} defaultValue={""} />
</div>
<div className={`flex w-full h-full items-center justify-center flex-col ${adresType?.value === 2 ? "" : "hidden"}`}>
            <span className='text-lg text-black w-full flex text-center justify-center font-bold bg-white'>
              Vergi Dairesi
            ...
            <input type='text' className="w-40 mt-2 h-[46px] border border-gray-500 rounded-lg px-2" onChange={e => setVergiDairesi(e.target.value)} defaultValue={""} />
</div>
      ...
      <textarea name="" id="" cols="30" rows="10" placeholder="Açıklama bina ve daire no'larınızı buraya ekleyiniz" className=' inline-flex w-[95%] h-[30%] m-auto rounded-xl border border-black shadow-sm shadow-gray-400 resize-none mt-4 p-1 -z-50' defaultValue={""} onChange={e => setAdresTarif(e.target.value)}></textarea>
